...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                .cors(cors -> cors.configurationSource(corsConfigurationSource())) // cors() metodu güncellendi
                .csrf(csrf -> csrf.disable()) // csrf() metodu güncellendi
                .exceptionHandling(exceptions -> exceptions
                        .authenticationEntryPoint(handler)) // exceptionHandling() metodu güncellendi
                .sessionManagement(session -> session
                        .sessionCreationPolicy(SessionCreationPolicy.STATELESS)) // sessionManagement() metodu güncellendi
